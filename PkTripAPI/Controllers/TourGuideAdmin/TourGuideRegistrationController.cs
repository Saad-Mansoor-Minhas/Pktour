...
namespace PkTripAPI.Controllers.TourGuideAdmin
{
    ...
    public class TourGuideRegistrationController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("myprofile/{tgId}")]
        public async Task<ActionResult> GetSpecificTourGuideRegistration(int tgId)
        {
            ...
            ContentResult result = new ContentResult();
            result = (ContentResult)await DalCRUD.ReadData("SP_GetSpecificTourGuide", sp);
            if (result != null)
            {
                return result;
            }
        ...
        public async Task SaveTourGuideRegistration(RegistrationModel registration)
        {
            SqlParameter[] sp =
            {
                ...
                new SqlParameter("@CompanySector",registration.TourGuideCompany.fk_AreaId)
            };
